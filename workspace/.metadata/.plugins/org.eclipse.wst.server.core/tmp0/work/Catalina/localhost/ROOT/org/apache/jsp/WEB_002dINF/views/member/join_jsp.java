 ...
 * Generated at: 2023-09-06 02:36:12 UTC
...
public final class join_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("var idckCheck = false;			//아이디 중복검사\r\n");
      ...
      out.write("		\r\n");
      out.write("		//입력값 변수\r\n");
      out.write("		var id = $('.id_input').val();		//id입력란\r\n");
      out.write("		var pw = $('.pw_input').val();		//pw입력란\r\n");
      out.write("		var pwck = $('.pwck_input').val();	//pwck입력란\r\n");
      out.write("		var name = $('.user_input').val();		//name입력란\r\n");
      out.write("		var mail = $('.mail_input').val();		//mail입력란\r\n");
      out.write("		var addr = $('.address_input_3').val();		//address입력란\r\n");
      out.write("		\r\n");
      out.write("		/* 아이디 유효성검사  */\r\n");
      out.write("		if(id == \"\"){\r\n");
      ...
      out.write("        }\r\n");
      out.write("        //위의 if문에서 유효성 검사 변수들 중 단 한개라도 false가 있을경우 해당 코드를 읽게됨\r\n");
      ...
      out.write("	\r\n");
      out.write("	var inputCode = $(\".mail_check_input\").val();		//입려코드\r\n");
      out.write("	var checkResult = $(\"#mail_check_input_box_warn\");	//비교결과\r\n");
      out.write("	\r\n");
      out.write("	\r\n");
      out.write("	//(inputCode : 사용자 입력 번호 / code : 이메일로 전송된 인증번호)\r\n");
      out.write("	if(inputCode == code){\r\n");
      out.write("		checkResult.html(\"인증번호가 일치합니다.\");			//일치할경우\r\n");
      out.write("		checkResult.attr(\"class\",\"correct\");\r\n");
      out.write("		mailnumCheck = true;\r\n");
      out.write("	}else{\r\n");
      out.write("		checkResult.html(\"인증번호를 다시 확인해주세요.\");		//일치하지 않을 경우\r\n");
      ...
      out.write("// 해석을 하면 매개변수 email이 form에 저장된 정규표현식에 부합할 경우 true를 부합하지 않을 경우 false를 반환하게 됩니다. \r\n");
