...
$(document).ready(function(){
	...
	$(".join_button").click(function(){
		...
		var pwck = $('.pwck_input').val();	//pwck입력란
		var name = $('.user_input').val();		//name입력란
		var mail = $('.mail_input').val();		//mail입력란
		var addr = $('.address_input_3').val();		//address입력란
        ...
        //위의 if문에서 유효성 검사 변수들 중 단 한개라도 false가 있을경우 해당 코드를 읽게됨
		return false;
...
$(".mail_check_input").blur(function(){
	...
	var inputCode = $(".mail_check_input").val();		//입려코드
